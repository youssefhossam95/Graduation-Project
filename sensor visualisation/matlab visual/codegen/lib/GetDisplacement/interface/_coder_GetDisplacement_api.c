/*
 * File: _coder_GetDisplacement_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL,
  "GetDisplacement", NULL, false, { 2045744189U, 2170104910U, 2743257031U,
    4284093946U }, NULL };
 ...
 * Return Type  : void
 */
void GetDisplacement_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  ...
  emxInit_real_T(&st, &acceleration, 2, true);
  emxInit_real_T(&st, &Displacement, 2, true);
...
/*
 * File trailer for _coder_GetDisplacement_api.c
 *
 * [EOF]
 */
